...
inline std::vector<const char*> model_changer_table = {
    "a_f_m_beach_01",
    "a_f_m_bevhills_01",
    "a_f_m_bevhills_02",
    "a_f_m_bodybuild_01",
    ...
    "ig_lamardavis_02",
    "cs_lestercrest_2",
    "hash_10366540_zuvbcwo_collision",
    "ig_golfer_b",
    "ig_hao_02",
    "cs_lestercrest_3",
    ...
    "csb_vagos_leader",
    "a_c_chimp_02",
    "hash_22425093_skmdkr_collision",
    "ig_mason_duggan",
    "cs_jimmydisanto2",
    "csb_musician_00",
    "IG_ISLDJ_04_D_01",
    ...
    "hash_12394276_cwvqvb_collision",
    "CSB_ISLDJ_02",
    "cs_drfriedlander_02",
    "a_c_mtlion_02",
    "ig_dax",
    ...
    "ig_vernon",
    "IG_JIO",
    "hash_28135809_nsskyvb_collision",
    "CS_Patricia_02",
    "hash_80921836_dmismjh_collision",
    "g_m_m_goons_01",
    "ig_roostermccraw",
