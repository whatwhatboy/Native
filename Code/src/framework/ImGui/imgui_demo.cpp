...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            const ImGuiID child_id = ImGui::get_id((void*)(intptr_t)i);
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            ImGuiID child_id = ImGui::get_id((void*)(intptr_t)i);
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    if (show_config_info)
    {
        ...
        ImGui::BeginChildFrame(ImGui::get_id("cfg_infos"), child_size, ImGuiWindowFlags_NoMove);
    ...
    if (!close_queue.empty())
    {
        ...
        else
        {
            ...
            if (ImGui::BeginPopupModal("Save?", NULL, ImGuiWindowFlags_AlwaysAutoResize))
            {
                ...
                if (ImGui::BeginChildFrame(ImGui::get_id("frame"), ImVec2(-FLT_MIN, 6.25f * item_height)))
                {
                    for (int n = 0; n < close_queue.Size; n++)
                        if (close_queue[n]->Dirty)
