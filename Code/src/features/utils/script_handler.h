...
#include <src/rage/script/scriptHandlerNetComponent.hpp>
#include <src/rage/script/scriptHandler.hpp>
#include <src/rage/script/scriptResource.hpp>
#include <src/rage/script/scriptIdBase.hpp>
#include <src/rage/script/scriptId.hpp>
#include <src/rage/script/dataList.hpp>
#pragma pack(push, 1)
namespace rage
{
